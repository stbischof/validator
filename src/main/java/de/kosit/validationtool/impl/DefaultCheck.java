...
public class DefaultCheck implements Check {
    ...
    public DefaultCheck(final CheckConfiguration configuration) {
        ...
        this.contentRepository = new ContentRepository(processor, configuration.getScenarioRepositoryPath(),
                configuration.getRepositorySource());
        ...
        this.checkSteps.add(new SchematronValidationAction(this.contentRepository));
